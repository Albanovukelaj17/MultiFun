...
- **HangMan**:
  ...
  - The game provides a visual representation of the word with underscores for unguessed letters and shows the number of
    incorrect guesses remaining.
  - If the player guesses the word correctly, they win; if they run out of lives, the game is lost, and a new word is 
    automatically generated for the next round.
